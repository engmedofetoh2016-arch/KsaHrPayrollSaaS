        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultPayDay = table.Column<int>(type: "integer", nullable: false),
                    CreatedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAtUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompanyProfileSet", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PayrollPeriodSet", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompanyProfileSet_TenantId",
                table: "CompanyProfileSet",
                column: "TenantId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_EmployeeSet_TenantId_Email",
                table: "EmployeeSet",
                columns: new[] { "TenantId", "Email" });

            migrationBuilder.CreateIndex(
                name: "IX_TenantSet_Slug",
                table: "TenantSet",
                column: "Slug",
                unique: true);
        }
