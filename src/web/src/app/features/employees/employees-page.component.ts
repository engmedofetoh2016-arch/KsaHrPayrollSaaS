...
export class EmployeesPageComponent implements OnInit, OnDestroy {
  ...
  startEdit(employee: Employee) {
    ...
    this.form.reset({
      ...
      gradeCode: employee.gradeCode ?? 'DEFAULT',
      locationCode: employee.locationCode ?? 'DEFAULT',
  ...
  private mapFormToEmployeeRequest() {
    ...
    return {
      ...
      gradeCode: value.gradeCode || 'DEFAULT',
      locationCode: value.locationCode || 'DEFAULT',
